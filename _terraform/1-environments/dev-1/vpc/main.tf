...
module "this" {
  ...
  cidr = "10.16.0.0/16"
  name = "dev-vpc"
  private_subnet_tags = {"kubernetes.io/cluster/eks-dev":"shared","kubernetes.io/role/internal-elb":"1"}
  private_subnets = ["10.16.1.0/24","10.16.2.0/24","10.16.3.0/24"]
  public_subnet_tags = {"kubernetes.io/cluster/eks-dev":"shared","kubernetes.io/role/elb":"1"}
